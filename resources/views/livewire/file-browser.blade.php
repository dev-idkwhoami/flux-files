                                    ...
                                    <flux:tooltip.content class="max-w-[20rem] space-y-2">
                                        <div class="flex flex-col">
                                            <flux:heading class="inline-flex gap-1 text-xs" level="5">
                                                File Size:
                                                <flux:text
                                                    class="text-xs">{{ $file->getHumanReadableSize() }}</flux:text>
                                            </flux:heading>
                                            <flux:heading class="inline-flex gap-1 text-xs" level="5">
                                                Modified:
                                                <flux:text
    ...
    document.addEventListener('livewire:init', () => {
        ...
        window.handleFileBrowserUpload = function (files) {
            ...
            for (let i = 0; i < fileArray.length; i++) {
                @this.
                upload('tempFile', fileArray[i], (uploadedFilename) => {
                    // File uploaded successfully - call backend to process it
                    @this.
                    call('processUploadedFile', uploadedFilename);
                }, () => {
